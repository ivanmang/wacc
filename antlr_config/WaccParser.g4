...
expr           : int_liter | bool_liter | CHAR_LIT | CHARACTER_LIT | pair_liter | expr binary_oper expr | ident | array_elem | unary_oper expr | OPEN_PARENTHESES expr CLOSE_PARENTHESES ;
